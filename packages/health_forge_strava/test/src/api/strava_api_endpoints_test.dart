...
void main() {
  group('StravaApiEndpoints', () {
    test('baseUrl points to Strava API v3', () {
      expect(StravaApiEndpoints.baseUrl, 'https://www.strava.com/api/v3');
    });
    ...
    test('tokenUrl points to Strava OAuth token endpoint', () {
      expect(StravaApiEndpoints.tokenUrl, 'https://www.strava.com/oauth/token');
    });

    test('athleteActivities is correct path', () {
      expect(StravaApiEndpoints.athleteActivities, '/athlete/activities');
    });

    test('activityDetail returns correct path', () {
      expect(StravaApiEndpoints.activityDetail(12345), '/activities/12345');
    });
