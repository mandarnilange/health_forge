...
/// Declares the metrics and sync model supported by Apple HealthKit.
class AppleCapabilities {
  const AppleCapabilities._();

  /// The full set of HealthKit capabilities exposed by this adapter.
