...
/// Maps Apple HealthKit sleep data points to core [SleepSession] records.
class SleepMapper {
  const SleepMapper._();

  static const _stageMap = <String, SleepStage>{
    'SLEEP_IN_BED': SleepStage.unknown,
